...
prefix = /workspaces/requery-sqlite-android/icu58-build/host/icu_build
exec_prefix = ${prefix}
...
CFLAGS = -O3 -Os -fno-short-wchar -fno-short-enums -ffunction-sections -fdata-sections -fvisibility=hidden         -DU_USING_ICU_NAMESPACE=0 -DU_HAVE_NL_LANGINFO_CODESET=0 -DU_TIMEZONE=0         -DU_DISABLE_RENAMING=1         -DUCONFIG_NO_COLLATION=0         -DUCONFIG_NO_FORMATTING=0         -DUCONFIG_NO_LEGACY_CONVERSION=1         -DUCONFIG_NO_REGULAR_EXPRESSIONS=0         -DUCONFIG_NO_TRANSLITERATION=0 -DU_STATIC_IMPLEMENTATION -fPIC $(THREADSCFLAGS) -Qunused-arguments -Wno-parentheses-equality
# CXXFLAGS is for C++ only flags
CXXFLAGS = -O3 -Os -fno-short-wchar -fno-short-enums -ffunction-sections -fdata-sections -fvisibility=hidden         -DU_USING_ICU_NAMESPACE=0 -DU_HAVE_NL_LANGINFO_CODESET=0 -DU_TIMEZONE=0         -DU_DISABLE_RENAMING=1         -DUCONFIG_NO_COLLATION=0         -DUCONFIG_NO_FORMATTING=0         -DUCONFIG_NO_LEGACY_CONVERSION=1         -DUCONFIG_NO_REGULAR_EXPRESSIONS=0         -DUCONFIG_NO_TRANSLITERATION=0 -DU_STATIC_IMPLEMENTATION -fPIC -std=c++11 $(THREADSCXXFLAGS) -Qunused-arguments -Wno-parentheses-equality
# CPPFLAGS is for C Pre-Processor flags
CPPFLAGS = -Os -fno-short-wchar -fno-short-enums -ffunction-sections -fdata-sections -fvisibility=hidden         -DU_USING_ICU_NAMESPACE=0 -DU_HAVE_NL_LANGINFO_CODESET=0 -DU_TIMEZONE=0         -DU_DISABLE_RENAMING=1         -DUCONFIG_NO_COLLATION=0         -DUCONFIG_NO_FORMATTING=0         -DUCONFIG_NO_LEGACY_CONVERSION=1         -DUCONFIG_NO_REGULAR_EXPRESSIONS=0         -DUCONFIG_NO_TRANSLITERATION=0 -DU_STATIC_IMPLEMENTATION -fPIC -ffunction-sections -fdata-sections $(THREADSCPPFLAGS)  -DU_HAVE_ELF_H=1 -DU_HAVE_ATOMIC=1 -DU_HAVE_STRTOD_L=1 -DU_HAVE_XLOCALE_H=0  -DU_DISABLE_RENAMING=1
...
LDFLAGS = -pthread -Wl,--gc-sections -Wl,--gc-sections $(RPATHLDFLAGS)
